package team.aio.api

import com.fasterxml.jackson.annotation.JsonInclude
import com.fasterxml.jackson.annotation.JsonProperty
import com.fasterxml.jackson.annotation.JsonPropertyOrder
import team.aio.api.code.BaseCode
import team.aio.api.code.status.SuccessStatus
...
class ApiResponse<T> private constructor(
    ...
    companion object {
        ...
        fun <T> onSuccess(code: BaseCode, data: T) =
            ApiResponse(
                isSuccess = true,
        ...
        fun <T> onFailure(status: String, message: String, data: T?) =
